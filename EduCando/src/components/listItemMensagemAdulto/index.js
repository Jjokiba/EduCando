...
function ItemMensagemAdulto({codMensagem, mensagem, data_Mensagem, visto, remetente, nome_Crianca, nome_Res, FK_CodCrianca, FK_CodResponsavel, funcaoReload }) {
    ...
    useEffect(() => {
      ...
      if(remetente != "Responsavel" && !visto){
...
export default ItemMensagemAdulto;
